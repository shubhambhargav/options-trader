        ...
        questions = [
            ...
            },
            {
                ...
                'choices': [
                    ...
                    { 'name': 'COALINDIA', 'checked': True },
                    Separator('= Banking & Finance ='),
                    { 'name': 'ICICIBANK', 'checked': True },
                    { 'name': 'IDFCFIRSTB' },
                    { 'name': 'HDFCBANK', 'checked': True },
                    { 'name': 'M&MFIN', 'checked': True },
                    { 'name': 'KOTAKBANK', 'checked': True },
                    { 'name': 'BANDHANBNK', 'checked': True },
                    Separator('= Insurance ='),
                    { 'name': 'HDFCLIFE', 'checked': True },
                    Separator('= FMCG ='),
                    { 'name': 'HEROMOTOCO', 'checked': True },
                    { 'name': 'TITAN', 'checked': True },
                    { 'name': 'PIDILITIND', 'checked': True },
                    { 'name': 'ASIANPAINT', 'checked': True },
                    { 'name': 'MRF', 'checked': True },
                    { 'name': 'HINDUNILVR', 'checked': True },
                    { 'name': 'MARUTI', 'checked': True },
                    { 'name': 'NESTLEIND', 'checked': True },
                    Separator('= Emerging Market ='),
                    { 'name': 'HDFCAMC' },
                    Separator('= Tech ='),
                    { 'name': 'INFY', 'checked': True },
                    { 'name': 'TCS', 'checked': True },
                    { 'name': 'NAUKRI', 'checked': True },
                    { 'name': 'COFORGE' },
                    { 'name': 'MINDTREE' },
                    { 'name': 'LTI' },
                    { 'name': 'HCLTECH' },
                    ...
                    { 'name': 'DRREDDY' },
                    { 'name': 'TATACHEM' },
                    { 'name': 'RELIANCE', 'checked': True },
                    { 'name': 'BHARTIARTL' },
                    { 'name': 'PVR', 'checked': True },
                    { 'name': 'ITC', 'checked': True },
                ]
            }
        ]
